const SearchBox = () => {
  return (
    <div className="bg-white sm:bg-inherit sm:p-0 sm:min-w-[150px] sm:max-w-[225px] h-[15vh] py-4 w-full sm:h-auto shadow">
      <form className="items-center flex justify-between gap-2 py-2 sm:py-0 max-w-[90%] mx-auto sm:max-w-full ">
